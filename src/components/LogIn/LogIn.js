...
const Login = () => {
  ...
  return (
    <div>
        <img src="https://i.ibb.co/qYN5n9g/logo2.png" alt=""  style={{ height: '80px', display:'block',margin: '0 auto', marginTop: '50px' }}/>
      {/* log in and register form  */}
      <Card style={{ width: '25rem', margin: '0 auto',marginTop: '50px'}}>
        <Card.Body>
